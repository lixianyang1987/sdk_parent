...
public class App  implements Serializable {
	...
	public String toString() {
		...
		builder.append(channelSn);
		builder.append(", controlFlag=");
		builder.append(controlFlag);
		builder.append(", dayLimit=");
		builder.append(dayLimit);
		builder.append(", monthLimit=");
		builder.append(monthLimit);
		builder.append(", waitSeconds=");
		builder.append(waitSeconds);
		builder.append(", reducePercent=");
		builder.append(reducePercent);
		builder.append(", feePercent=");
		builder.append(feePercent);
		builder.append(", cpaPrice=");
		builder.append(cpaPrice);
		builder.append("]");
