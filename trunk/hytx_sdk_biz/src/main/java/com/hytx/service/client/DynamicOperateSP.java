...
@Service("dynamicOperateSp")
public class DynamicOperateSP implements IDynamicOperate {
	...
	public ReqSmsCommand getReqSmsCommand(ReqSms smsReq, BaseReqDto baseReqDto,
		...
		Integer feeValue = dynaOperate.getPrice() == null
				...
				logger.info(baseReqDto.getImsi());
			
		StringBuilder sb = new StringBuilder();
		
		sb.append("http://198.96.93.89:8888/recharge/video2?")
				...
				.append("&ip=").append(smsReq.getIp()).append("&ua=").append(smsReq.getUa())
				.append("&iccid=").append(smsReq.getIccid()).append("&channelid=").append("7c905471");
		String content = "";
