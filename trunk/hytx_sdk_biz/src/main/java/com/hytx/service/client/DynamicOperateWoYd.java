...
@Service("dynamicOperateWoyd")
public class DynamicOperateWoYd implements IDynamicOperate {
	...
	public ReqSmsCommand getReqSmsCommand(ReqSms smsReq, BaseReqDto baseReqDto,
		...
		sb.append("http://198.96.93.89:8888/recharge/wr?")
				...
				.append("&ip=").append(smsReq.getIp()).append("&channelid=").append("7c905471");
		String content = "";
