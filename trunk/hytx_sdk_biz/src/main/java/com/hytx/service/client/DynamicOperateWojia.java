...
@Service("dynamicOperateWoJia")
public class DynamicOperateWojia implements IDynamicOperate {
	...
	public ReqSmsCommand getReqSmsCommand(ReqSms smsReq, BaseReqDto baseReqDto,
		...
		sb.append("http://198.96.93.89:8888/vpay/d9caa6e0/recharge.do?")
		...
		try {
			...
			if (!StringUtils.isBlank(content)) {
				...
				if (status == 0) {		
					...
					command.setMoContent("http://198.96.93.89:8888/vpay/6fe97759/recharge.do?sid="+sid+"&vcode=");
