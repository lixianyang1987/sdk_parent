 ...
 <%@include file="../../common/top.jsp" %>
  ...
  <fieldset class="top-fieldset" >
     <div id="tb" style="padding:5px;height:auto">
          <form:form  action="countSyncAppByDate" method="post" id="findForm">
		       <table id="findTable">
			      <tr>
	...
	<table id="dg"  style="width:auto;height:auto;">
		...
		function coculateTotal(){
			...
			$('#dg').datagrid('appendRow',{
				...
				上行成功率:upSms==0||upSucSms==0?"0%":parseInt(upSucSms*100/upSms)+"%",
				用户请求率:cpReq==0||upSms==0?"0%":parseInt(upSms*100/cpReq)+"%",
				计费成功率:sync==0||syncSuc==0?"0%":parseInt(syncSuc*100/sync)+"%",
				通道转化率:upSms==0||syncSuc==0?"0%":parseInt(syncSuc*100/upSucSms)+"%",
		     });
