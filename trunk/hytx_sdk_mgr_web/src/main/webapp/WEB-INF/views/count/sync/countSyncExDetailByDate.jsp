 ...
 <%@include file="../../common/top.jsp" %>
  ...
  <fieldset class="top-fieldset" >
     <div id="tb" style="padding:5px;height:auto">
          <form:form  action="countSyncExDetailByDate" method="post" id="findForm">
		       <table id="findTable">
		          <tr>
	...
	<table id="dg"  style="width:auto;height:auto;">
		<thead>
			<tr>
			    ...
			    <th data-options="field:'是否扣量',sortable:true,align:'center'">是否扣量</th> 
			...
			<tbody>
				<c:forEach items="${list}" var="item">
					<tr>
			           ...
			           <td><img src="${basePath}/images/${item.reduceStatus==1?'ok':'no'}.png"/></td>
