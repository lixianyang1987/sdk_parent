		...
		<form:form id="addOrEditUserForm" action="addOrEditUser"  method="post" commandName="user" data-options="ajax:false">
			...
			<table>  
			   <tr>	
			   		...
			   		class="easyui-validatebox" data-options="required:true,delay:1000,missingMessage:'请输入用户名',validType:['length[3,30]','exists']"  maxlength="30"/></td>
			   </tr>
			   <tr>
			      	<th>登录名：</th>
			   		<td><input type="text" id="loginName" name="loginName" value="${user.loginName}" 
			   		class="easyui-validatebox" data-options="required:true,delay:1000,validType:['length[3,30]','existsLoginName']"  maxlength="30"/></td>
			   </tr>
			   <tr>
			   		<th>登录密码：</th>
			   		<td><input type="password" id="loginPwd" name="loginPwd" value="${mobileUser.loginPwd}" class="easyui-validatebox"  data-options="required:true"  maxlength="14"/></td>
			   </tr>
			    <tr>
			        <th>备注：</th>
			   		<td>
